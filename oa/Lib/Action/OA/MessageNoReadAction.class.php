...
class MessageNoReadAction extends loginAction{
...
//        dump($a);die;
    ...
    public function MessageNoReadPage(){
        //根据当前的id去查找
        $id = $_SESSION['id'];
        $data = DataPage(array('database'=>'message','order'=>'addtime desc','para'=>" and FIND_IN_SET($id,noread)"));
        echo json_encode($data);
    }

    public function MessageNoReadData()
    {
        $id = I('post.id');
