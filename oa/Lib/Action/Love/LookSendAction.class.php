...
class LookSendAction extends loginAction{
    ...
    public function LookSendPage(){
        ...
        $data = DataPage(array('database'=>'love','order'=>'send_time desc','para'=>" and sp_res = 1 and send_user = '$username' and $FirstDays < send_time <$LastDays"));
        $data['date'] = array($day[0],end($day));
        echo json_encode($data);
    }
    public function LookSendData(){
