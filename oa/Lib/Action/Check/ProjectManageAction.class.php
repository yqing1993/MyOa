<?php
class ProjectManageAction extends loginAction {
	function __construct(){
		parent::__construct();
		role('ProjectManage',3);
	}
	...
	public function ProjectManagePage(){
		$data = DataPage(array('database'=>'j_project','order'=>'rank desc'));

		echo json_encode($data);
	}

	public function ProjectManageData(){
		$id = I('post.id');
